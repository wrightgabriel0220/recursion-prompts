...
var factorial = function(n) {
  // INPUT: a number
  // OUTPUT: a number representing the factorial of number n
  // EDGE CASES: n is a negative number - doesn't have a factorial
  // number is 0; it's factorial is one
  // base cases:
  if (n < 0) {
    return null;
  }
...
var isEven = function(n) {
  ...
  var num = Math.abs(n);
  // subtract 2 until reaching 0 or getting to a point
  // where we can't subtract further without going negative
  // BASE CASES:
  // if we reach 0, even/true
  if (num === 0) {
    return true;
  }
  // if not, odd/false
